...
import { LoginRequest, ChangePinRequest, MemberCreatedByAgentRequest,DonationCollectedRequest ,TransactionListAgentRequest} from '../../protos/gen/AgentMobile_pb'
...
function agentAPI() {
    ...
    async function loginAgent(params) {
        ...
        request.setMobilenumber(params.Number) //ANCHOR - setting phone number
        request.setPin(params.Pin) //ANCHOR - setting pin
    ...
    async function getTotalDonation(params){
        ...
        return new Promise((resolve,reject)=>{
            client.getTotalDonationCollectedByAgent(request,METADATA,(err,response)=>{
                if(err) {
                    reject(err)
                }
    ...
    async function getMemberCreateByAgent(params){
        ...
        return new Promise((resolve,reject)=>{
            client.getListOfGGCMembersCreatedByAgent(request,METADATA,(err,response)=>{
                if(err) {
                    reject(err)
                }
                const result = response?.toObject() //ANCHOR - converting response to object
    ...
    return { loginAgent, changeAgentPin, getMemberTransactions,getTotalDonation,getMemberCreateByAgent }

 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.Transaction.StatusCheckRequest,
 *   !proto.Transaction.StatusCheckResponse>}
 */
const methodDescriptor_TransactionSvc_UpdatePendingTransactionsCheckingWithEganow = new grpc.web.MethodDescriptor(
  '/Transaction.TransactionSvc/UpdatePendingTransactionsCheckingWithEganow',
  grpc.web.MethodType.UNARY,
  proto.Transaction.StatusCheckRequest,
  proto.Transaction.StatusCheckResponse,
  /**
   * @param {!proto.Transaction.StatusCheckRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.Transaction.StatusCheckResponse.deserializeBinary
);


/**
 * @param {!proto.Transaction.StatusCheckRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.Transaction.StatusCheckResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.Transaction.StatusCheckResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.Transaction.TransactionSvcClient.prototype.updatePendingTransactionsCheckingWithEganow =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/Transaction.TransactionSvc/UpdatePendingTransactionsCheckingWithEganow',
      request,
      metadata || {},
      methodDescriptor_TransactionSvc_UpdatePendingTransactionsCheckingWithEganow,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.Transaction.StatusCheckResponse>}
 *     Promise that resolves to the response
 */
proto.Transaction.TransactionSvcPromiseClient.prototype.updatePendingTransactionsCheckingWithEganow =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/Transaction.TransactionSvc/UpdatePendingTransactionsCheckingWithEganow',
      request,

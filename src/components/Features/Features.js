                    ...
                    <div className="col-md-4">
                        <div className="wpo-service-item shadow rounded-3">
                            <div className="wpo-service-text p-2">
                                ...
                                <p className="p-2 m-0 text-center">Lorem Ipsum is simply dummy text
                                    the industrey's standard dummy text ever
                                    scrambled type specimen
                                </p>
                                <div className="text-center p-2 m-0">
                                    <button type="button" className="btn btn-success">Click To Donate</button>
                                </div>
                    ...
                    <div className="col-md-4">
                        <div className="wpo-service-item shadow rounded-3">
                            <div className="wpo-service-text p-2">
                                ...
                                <div className="text-center p-2 m-0">
                                    <button type="button" className="btn btn-success">Click To Get Card</button>
                                </div>

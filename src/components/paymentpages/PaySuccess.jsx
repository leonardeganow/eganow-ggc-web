  ...
  React.useEffect(() => {
    if (redirectContainerRef.current) {
      ...
      if (scriptElement) {
        ...
        const iFrame = redirectContainerRef.current.querySelector('#redirectTo3ds1Frame') //iframe container
        if (iFrame) {
    ...
    <div className="">
      ...
      <h5 className="text-center my-4">
        {transType === "Debit card" ? (
          <div>
            <div id="spinner" style={{ display: 'none' }} className="text-center">
            ...
            <div style={{ height: '400px',display:'none' }} ref={redirectContainerRef}></div>
          </div>
